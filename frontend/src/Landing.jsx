...
function Landing() {
  ...
  return (
    ...
    <div className="navbar">
      <div className="logo">
        <h1><i class="ri-bnb-fill"></i>100x</h1>
      </div>
      ...
      <div className="thirdpart">
        <a href="https://github.com/Abhishek00810/course-selling-full-stack" target="_blank">
        <h3 onclick="window.location.href='https://github.com/Abhishek00810/course-selling-full-stack';">Github Code</h3>
        </a>
      </div>
    </div>
